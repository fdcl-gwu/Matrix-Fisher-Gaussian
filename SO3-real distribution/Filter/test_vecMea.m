...
parameters.initRNoise = diag([2e-10,1e-10,0]);
...
save('D:\result-SO3Euclid\5-14-2020','gyro','vRef','vMea','RTrue','xTrue','parameters','RMEKF','xMEKF','G','TMEKF','RMFGA','MFGA','TMFGA','RMFGU','MFGU','TMFGU');
