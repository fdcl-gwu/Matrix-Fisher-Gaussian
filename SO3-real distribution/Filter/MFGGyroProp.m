...
EQ = diag(pdf_MF_moment(s));
EQQ = pdf_MF_moment2(s);
EQQQ = pdf_MF_moment3(s);

%% E[R(t+dt)]
ERt = U*EQ*V';

EQ1a(1,1) = (V(2,3)*P(2,3)-V(2,2)*P(3,3))*(s(2)*EQQ(2,2)-s(1)*EQQ(2,4))+...
    (V(3,2)*P(3,2)-V(3,3)*P(2,2))*(s(3)*EQQ(3,3)-s(1)*EQQ(3,7));
EQ1a(1,2) = (V(2,1)*P(3,3)-V(2,3)*P(1,3))*(s(2)*EQQ(2,2)-s(1)*EQQ(2,4))+...
    (V(3,3)*P(1,2)-V(3,1)*P(3,2))*(s(3)*EQQ(3,3)-s(1)*EQQ(3,7));
EQ1a(1,3) = (V(2,2)*P(1,3)-V(2,1)*P(2,3))*(s(2)*EQQ(2,2)-s(1)*EQQ(2,4))+...
    (V(3,1)*P(2,2)-V(3,2)*P(1,2))*(s(3)*EQQ(3,3)-s(1)*EQQ(3,7));
EQ1a(2,1) = (V(1,2)*P(3,3)-V(1,3)*P(2,3))*(s(1)*EQQ(4,4)-s(2)*EQQ(4,2))+...
    (V(3,3)*P(2,1)-V(3,2)*P(3,1))*(s(3)*EQQ(6,6)-s(2)*EQQ(6,8));
EQ1a(2,2) = (V(1,3)*P(1,3)-V(1,1)*P(3,3))*(s(1)*EQQ(4,4)-s(2)*EQQ(4,2))+...
    (V(3,1)*P(3,1)-V(3,3)*P(1,1))*(s(3)*EQQ(6,6)-s(2)*EQQ(6,8));
EQ1a(2,3) = (V(1,1)*P(2,3)-V(1,2)*P(1,3))*(s(1)*EQQ(4,4)-s(2)*EQQ(4,2))+...
    (V(3,2)*P(1,1)-V(3,1)*P(2,1))*(s(3)*EQQ(6,6)-s(2)*EQQ(6,8));
EQ1a(3,1) = (V(1,3)*P(2,2)-V(1,2)*P(3,2))*(s(1)*EQQ(7,7)-s(3)*EQQ(7,3))+...
    (V(2,2)*P(3,1)-V(2,3)*P(2,1))*(s(2)*EQQ(8,8)-s(3)*EQQ(8,6));
EQ1a(3,2) = (V(1,1)*P(3,2)-V(1,3)*P(1,2))*(s(1)*EQQ(7,7)-s(3)*EQQ(7,3))+...
    (V(2,3)*P(1,1)-V(2,1)*P(3,1))*(s(2)*EQQ(8,8)-s(3)*EQQ(8,6));
...
EQ2a(1,3) = s(2)*ST(1,3)*EQQ(6,8) - s(3)*ST(1,3)*EQQ(6,6);
EQ2a(2,1) = s(3)*ST(2,1)*EQQ(3,7) - s(1)*ST(2,1)*EQQ(3,3);
EQ2a(2,2) = (s(1)*ST(1,1)+s(3)*ST(3,3))*EQQ(3,3) - (s(1)*ST(3,3)+s(3)*ST(1,1))*EQQ(3,7);
EQ2a(2,3) = s(1)*ST(2,3)*EQQ(3,7) - s(3)*ST(2,3)*EQQ(3,3);
...
uV = Miu'*V;
EQ2d(1,1) = (uV(3)*ST(2,1)-uV(1)*ST(2,3))*EQ(2,2) + (uV(1)*ST(3,2)-uV(2)*ST(3,1))*EQ(3,3);
EQ2d(1,2) = (uV(1)*ST(1,3)-uV(3)*ST(1,1))*EQ(2,2);
EQ2d(1,3) = (uV(2)*ST(1,1)-uV(1)*ST(1,2))*EQ(3,3);
EQ2d(2,1) = (uV(3)*ST(2,2)-uV(2)*ST(2,3))*EQ(1,1);
EQ2d(2,2) = (uV(2)*ST(1,3)-uV(3)*ST(1,2))*EQ(1,1) + (uV(1)*ST(3,2)-uV(2)*ST(3,1))*EQ(3,3);
EQ2d(2,3) = (uV(2)*ST(2,1)-uV(1)*ST(2,2))*EQ(3,3);
EQ2d(3,1) = (uV(3)*ST(3,2)-uV(2)*ST(3,3))*EQ(1,1);
EQ2d(3,2) = (uV(1)*ST(3,3)-uV(3)*ST(3,1))*EQ(2,2);
EQ2d(3,3) = (uV(2)*ST(1,3)-uV(3)*ST(1,2))*EQ(1,1) + (uV(3)*ST(2,1)-uV(1)*ST(2,3))*EQ(2,2);

EQ2e(1,1) = (PV(1,1)*ST(3,3)-PV(1,3)*ST(3,1))*((s(2)^2+s(3)^2)*EQQQ(5,6,6)-2*s(2)*s(3)*EQQQ(5,6,8))...
    + (PV(1,1)*ST(2,2)-PV(1,2)*ST(2,1))*((s(2)^2+s(3)^2)*EQQQ(9,6,6)-2*s(2)*s(3)*EQQQ(9,6,8))...
    + (PV(3,2)*ST(2,3)-PV(3,3)*ST(2,2))*(s(2)*s(3)*EQQQ(2,6,7)+s(1)*s(2)*EQQQ(8,4,7)-s(1)*s(3)*EQQQ(6,7,4)-s(2)^2*EQQQ(7,2,8))...
    + (PV(2,3)*ST(3,2)-PV(2,2)*ST(3,3))*(s(2)*s(3)*EQQQ(3,8,4)+s(1)*s(3)*EQQQ(6,7,4)-s(1)*s(2)*EQQQ(8,4,7)-s(3)^2*EQQQ(4,3,6));
EQ2e(1,2) = (PV(1,2)*ST(3,3)-PV(1,3)*ST(3,2))*((s(2)^2+s(3)^2)*EQQQ(1,6,6)-2*s(2)*s(3)*EQQQ(1,6,8))...
    + (PV(1,2)*ST(1,1)-PV(1,1)*ST(1,2))*((s(2)^2+s(3)^2)*EQQQ(9,6,6)-2*s(2)*s(3)*EQQQ(9,6,8))...
    + (PV(3,1)*ST(3,2)-PV(3,2)*ST(3,1))*(s(1)*s(2)*EQQQ(8,4,3)+s(2)*s(3)*EQQQ(2,6,3)-s(1)*s(3)*EQQQ(4,3,6)-s(2)^2*EQQQ(3,8,2))...
    + (PV(3,3)*ST(1,2)-PV(3,2)*ST(1,3))*(s(2)*s(3)*EQQQ(2,6,7)+s(1)*s(2)*EQQQ(8,4,7)-s(1)*s(3)*EQQQ(6,7,4)-s(2)^2*EQQQ(7,2,8))...
    + (PV(2,1)*ST(3,3)-PV(2,3)*ST(3,1))*(s(1)*s(2)*EQQQ(7,2,8)+s(3)^2*EQQQ(2,6,3)-s(1)*s(3)*EQQQ(7,2,6)-s(2)*s(3)*EQQQ(3,8,2));
EQ2e(1,3) = (PV(1,3)*ST(2,2)-PV(1,2)*ST(2,3))*((s(2)^2+s(3)^2)*EQQQ(1,6,6)-2*s(2)*s(3)*EQQQ(1,6,8))...
    + (PV(1,3)*ST(1,1)-PV(1,1)*ST(1,3))*((s(2)^2+s(3)^2)*EQQQ(5,6,6)-2*s(2)*s(3)*EQQQ(5,6,8))...
    + (PV(2,3)*ST(2,1)-PV(2,1)*ST(2,3))*(s(1)*s(2)*EQQQ(7,2,8)+s(3)^2*EQQQ(2,6,3)-s(1)*s(3)*EQQQ(7,2,6)-s(2)*s(3)*EQQQ(3,8,2))...
    + (PV(2,3)*ST(1,2)-PV(2,2)*ST(1,3))*(s(1)*s(2)*EQQQ(8,4,7)+s(3)^2*EQQQ(4,3,6)-s(1)*s(3)*EQQQ(6,7,4)-s(2)*s(3)*EQQQ(4,3,8))...
    + (PV(3,2)*ST(2,1)-PV(3,1)*ST(2,2))*(s(1)*s(2)*EQQQ(8,4,3)+s(2)*s(3)*EQQQ(2,6,3)-s(1)*s(3)*EQQQ(4,3,6)-s(2)^2*EQQQ(3,8,2));
EQ2e(2,1) = (PV(2,1)*ST(3,3)-PV(2,3)*ST(3,1))*((s(1)^2+s(3)^2)*EQQQ(5,3,3)-2*s(1)*s(3)*EQQQ(5,3,7))...
    + (PV(2,1)*ST(2,2)-PV(2,2)*ST(2,1))*((s(1)^2+s(3)^2)*EQQQ(9,3,3)-2*s(1)*s(3)*EQQQ(9,3,7))...
    + (PV(3,1)*ST(3,2)-PV(3,2)*ST(3,1))*(s(1)^2*EQQQ(6,7,4)+s(2)*s(3)*EQQQ(2,6,3)-s(1)*s(2)*EQQQ(6,7,2)-s(1)*s(3)*EQQQ(4,3,6))...
    + (PV(3,1)*ST(2,3)-PV(3,3)*ST(2,1))*(s(1)^2*EQQQ(8,4,7)+s(2)*s(3)*EQQQ(3,8,2)-s(1)*s(2)*EQQQ(7,2,8)-s(1)*s(3)*EQQQ(8,4,3))...
    + (PV(1,2)*ST(3,3)-PV(1,3)*ST(3,2))*(s(1)*s(2)*EQQQ(8,4,7)+s(3)^2*EQQQ(4,3,6)-s(1)*s(3)*EQQQ(6,7,4)-s(2)*s(3)*EQQQ(4,3,8));
EQ2e(2,2) = (PV(2,2)*ST(3,3)-PV(2,3)*ST(3,2))*((s(1)^2+s(3)^2)*EQQQ(1,3,3)-2*s(1)*s(3)*EQQQ(1,3,7))...
    + (PV(2,2)*ST(1,1)-PV(2,1)*ST(1,2))*((s(1)^2+s(3)^2)*EQQQ(9,3,3)-2*s(1)*s(3)*EQQQ(9,3,7))...
    + (PV(3,3)*ST(1,1)-PV(3,1)*ST(1,3))*(s(1)^2*EQQQ(8,4,7)+s(2)*s(3)*EQQQ(3,8,2)-s(1)*s(2)*EQQQ(7,2,8)-s(1)*s(3)*EQQQ(8,4,3))...
    + (PV(1,1)*ST(3,3)-PV(1,3)*ST(3,1))*(s(1)*s(2)*EQQQ(7,2,8)+s(3)^2*EQQQ(2,6,3)-s(1)*s(3)*EQQQ(2,6,7)-s(2)*s(3)*EQQQ(3,8,2));
EQ2e(2,3) = (PV(2,3)*ST(2,2)-PV(2,2)*ST(2,3))*((s(1)^2+s(3)^2)*EQQQ(1,3,3)-2*s(1)*s(3)*EQQQ(1,3,7))...
    + (PV(2,3)*ST(1,1)-PV(2,1)*ST(1,3))*((s(1)^2+s(3)^2)*EQQQ(5,3,3)-2*s(1)*s(3)*EQQQ(5,3,7))...
    + (PV(1,3)*ST(2,1)-PV(1,1)*ST(2,3))*(s(1)*s(2)*EQQQ(7,2,8)+s(3)^2*EQQQ(2,6,3)-s(1)*s(3)*EQQQ(2,6,7)-s(2)*s(3)*EQQQ(3,8,2))...
    + (PV(1,3)*ST(1,2)-PV(1,2)*ST(1,3))*(s(1)*s(2)*EQQQ(8,4,7)+s(3)^2*EQQQ(4,3,6)-s(1)*s(3)*EQQQ(6,7,4)-s(2)*s(3)*EQQQ(4,3,8))...
    + (PV(3,2)*ST(1,1)-PV(3,1)*ST(1,2))*(s(1)^2*EQQQ(6,7,4)+s(2)*s(3)*EQQQ(2,6,3)-s(1)*s(2)*EQQQ(6,7,2)-s(1)*s(3)*EQQQ(4,3,6));
EQ2e(3,1) = (PV(3,1)*ST(3,3)-PV(3,3)*ST(3,1))*((s(1)^2+s(2)^2)*EQQQ(5,2,2)-2*s(1)*s(2)*EQQQ(5,2,4))...
    + (PV(3,1)*ST(2,2)-PV(3,2)*ST(2,1))*((s(1)^2+s(2)^2)*EQQQ(9,2,2)-2*s(1)*s(2)*EQQQ(9,2,4))...
    + (PV(2,1)*ST(3,2)-PV(2,2)*ST(3,1))*(s(1)^2*EQQQ(6,7,4)+s(2)*s(3)*EQQQ(2,6,3)-s(1)*s(2)*EQQQ(2,6,7)-s(1)*s(3)*EQQQ(4,3,6))...
    + (PV(2,1)*ST(2,3)-PV(2,3)*ST(2,1))*(s(1)^2*EQQQ(8,4,7)+s(2)*s(3)*EQQQ(3,8,2)-s(1)*s(2)*EQQQ(7,2,8)-s(1)*s(3)*EQQQ(4,3,8))...
    + (PV(1,2)*ST(2,3)-PV(1,3)*ST(2,2))*(s(1)*s(2)*EQQQ(8,4,7)+s(2)*s(3)*EQQQ(2,6,7)-s(2)^2*EQQQ(7,2,8)-s(1)*s(3)*EQQQ(6,7,4));
EQ2e(3,2) = (PV(3,2)*ST(3,3)-PV(3,3)*ST(3,2))*((s(1)^2+s(2)^2)*EQQQ(1,2,2)-2*s(1)*s(2)*EQQQ(1,2,4))...
    + (PV(3,2)*ST(1,1)-PV(3,1)*ST(1,2))*((s(1)^2+s(2)^2)*EQQQ(9,2,2)-2*s(1)*s(2)*EQQQ(9,2,4))...
    + (PV(1,1)*ST(3,2)-PV(1,2)*ST(3,1))*(s(1)*s(2)*EQQQ(8,4,3)+s(2)*s(3)*EQQQ(2,8,3)-s(2)^2*EQQQ(3,7,2)-s(1)*s(3)*EQQQ(4,3,6))...
    + (PV(1,3)*ST(1,2)-PV(1,2)*ST(1,3))*(s(1)*s(2)*EQQQ(8,4,7)+s(2)*s(3)*EQQQ(2,6,7)-s(2)^2*EQQQ(7,2,8)-s(1)*s(3)*EQQQ(6,7,4))...
    + (PV(2,3)*ST(1,1)-PV(2,1)*ST(1,3))*(s(1)^2*EQQQ(8,4,7)+s(2)*s(3)*EQQQ(3,8,2)-s(1)*s(2)*EQQQ(7,2,8)-s(1)*s(3)*EQQQ(4,3,8));
EQ2e(3,3) = (PV(3,3)*ST(2,2)-PV(3,2)*ST(2,3))*((s(1)^2+s(2)^2)*EQQQ(1,2,2)-2*s(1)*s(2)*EQQQ(1,2,4))...
    + (PV(3,3)*ST(1,1)-PV(3,1)*ST(1,3))*((s(1)^2+s(2)^2)*EQQQ(5,2,2)-2*s(1)*s(2)*EQQQ(5,2,4))...
    + (PV(2,2)*ST(1,1)-PV(2,1)*ST(1,2))*(s(1)^2*EQQQ(6,7,4)+s(2)*s(3)*EQQQ(2,6,3)-s(1)*s(2)*EQQQ(2,6,7)-s(1)*s(3)*EQQQ(4,3,6))...
    + (PV(1,2)*ST(2,1)-PV(1,1)*ST(2,2))*(s(1)*s(2)*EQQQ(8,4,3)+s(2)*s(3)*EQQQ(2,8,3)-s(2)^2*EQQQ(3,7,2)-s(1)*s(3)*EQQQ(4,3,6));
...
EQ3a(1,1) = (ST(3,1)*ST(3,2)*uV(3)-ST(3,2)*ST(3,3)*uV(1))*EQQ(5,5)...
    ...
    + (ST(3,1)*ST(3,3)*uV(2)-ST(3,1)*ST(3,2)*uV(3))*EQQ(2,2)...
    + (ST(2,1)*ST(2,3)*uV(2)-ST(2,1)*ST(2,2)*uV(3))*EQQ(3,3)...
    + (ST(2,1)*ST(2,2)*uV(3)-ST(2,2)*ST(2,3)*uV(1)-ST(3,1)*ST(3,3)*uV(2)+ST(3,2)*ST(3,3)*uV(1))*EQQ(6,6)...
    + (ST(2,2)*ST(3,1)*uV(2)-ST(2,2)*ST(3,2)*uV(1)-ST(2,1)*ST(3,3)*uV(3)+ST(2,3)*ST(3,3)*uV(1))*EQQ(6,8);
EQ3a(1,2) = (ST(3,2)^2*uV(3)-ST(3,2)*ST(3,3)*uV(2))*EQQ(1,5)...
    + (ST(2,3)*ST(3,3)*uV(2)-ST(2,3)*ST(3,2)*uV(3))*EQQ(1,9)...
    + (ST(1,2)*ST(3,2)*uV(1)-ST(1,1)*ST(3,2)*uV(2))*EQQ(5,9)...
    + (ST(1,1)*ST(2,3)*uV(2)-ST(1,2)*ST(2,3)*uV(1))*EQQ(9,9)...
    + (ST(3,1)*ST(3,3)*uV(1)-ST(3,1)^2*uV(3))*EQQ(2,4)...
    + (ST(1,2)*ST(2,1)*uV(3)-ST(1,3)*ST(2,1)*uV(2))*EQQ(3,3)...
    + (ST(2,1)*ST(3,2)*uV(1)-ST(2,1)*ST(3,1)*uV(2))*EQQ(3,7)...
    + (ST(1,3)*ST(2,2)*uV(1)-ST(1,1)*ST(2,2)*uV(3))*EQQ(6,6)...
    + (ST(1,1)*ST(3,3)*uV(3)-ST(1,3)*ST(3,3)*uV(1))*EQQ(6,8);
EQ3a(1,3) = (ST(2,3)*ST(3,2)*uV(2)-ST(2,2)*ST(3,2)*uV(3))*EQQ(1,5)...
    + (ST(2,2)*ST(2,3)*uV(3)-ST(2,3)^2*uV(2))*EQQ(1,9)...
    + (ST(1,3)*ST(3,2)*uV(1)-ST(1,1)*ST(3,2)*uV(3))*EQQ(5,5)...
    + (ST(1,1)*ST(2,3)*uV(3)-ST(1,3)*ST(2,3)*uV(1))*EQQ(5,9)...
    + (ST(1,2)*ST(3,1)*uV(3)-ST(1,3)*ST(3,1)*uV(2))*EQQ(2,2)...
    + (ST(2,1)*ST(3,1)*uV(3)-ST(2,3)*ST(3,1)*uV(1))*EQQ(2,4)...
    + (ST(2,1)^2*uV(2)-ST(2,1)*ST(2,2)*uV(1))*EQQ(3,7)...
    + (ST(1,1)*ST(3,3)*uV(2)-ST(1,2)*ST(3,3)*uV(1))*EQQ(6,6)...
    + (ST(1,2)*ST(2,2)*uV(1)-ST(1,1)*ST(2,2)*uV(2))*EQQ(6,8);
EQ3a(2,1) = (ST(3,1)*ST(3,3)*uV(1)-ST(3,1)^2*uV(3))*EQQ(1,5)...
    + (ST(2,2)*ST(3,1)*uV(1)-ST(2,1)*ST(3,1)*uV(2))*EQQ(1,9)...
    + (ST(1,3)*ST(3,1)*uV(3)-ST(1,3)*ST(3,3)*uV(1))*EQQ(5,9)...
    + (ST(1,3)*ST(2,1)*uV(2)-ST(1,3)*ST(2,2)*uV(1))*EQQ(9,9)...
    + (ST(3,2)^2*uV(3)-ST(3,2)*ST(3,3)*uV(2))*EQQ(2,4)...
    + (ST(1,1)*ST(2,2)*uV(3)-ST(1,1)*ST(2,3)*uV(2))*EQQ(3,3)...
    + (ST(2,3)*ST(3,3)*uV(2)-ST(2,2)*ST(3,3)*uV(3))*EQQ(3,7)...
    + (ST(1,2)*ST(2,3)*uV(1)-ST(1,2)*ST(2,1)*uV(3))*EQQ(6,6)...
    + (ST(1,2)*ST(3,2)*uV(1)-ST(1,2)*ST(3,1)*uV(2))*EQQ(6,8);
EQ3a(2,2) = (ST(3,1)*ST(3,3)*uV(2)-ST(3,1)*ST(3,2)*uV(3))*EQQ(1,1)...
    + (ST(1,1)*ST(3,1)*uV(2)-ST(1,2)*ST(3,1)*uV(1)+ST(1,3)*ST(3,2)*uV(3)-ST(1,3)*ST(3,3)*uV(2))*EQQ(1,9)...
    + (ST(1,2)*ST(1,3)*uV(1)-ST(1,1)*ST(1,3)*uV(2))*EQQ(9,9)...
    + (ST(3,1)*ST(3,2)*uV(3)-ST(3,2)*ST(3,3)*uV(1))*EQQ(2,2)...
    + (ST(1,1)*ST(1,3)*uV(2)-ST(1,1)*ST(1,2)*uV(3)-ST(3,1)*ST(3,3)*uV(2)+ST(3,2)*ST(3,3)*uV(1))*EQQ(3,3)...
    + (ST(1,1)*ST(3,1)*uV(2)-ST(1,1)*ST(3,2)*uV(1)+ST(1,2)*ST(3,3)*uV(3)-ST(1,3)*ST(3,3)*uV(2))*EQQ(3,7)...
    + (ST(1,1)*ST(1,2)*uV(3)-ST(1,2)*ST(1,3)*uV(1))*EQQ(6,6);
EQ3a(2,3) = (ST(2,2)*ST(3,1)*uV(3)-ST(2,3)*ST(3,1)*uV(2))*EQQ(1,1)...
    + (ST(1,1)*ST(3,1)*uV(3)-ST(1,3)*ST(3,1)*uV(1))*EQQ(1,5)...
    + (ST(1,3)*ST(2,3)*uV(2)-ST(1,3)*ST(2,2)*uV(3))*EQQ(1,9)...
    + (ST(1,3)^2*uV(1)-ST(1,1)*ST(1,3)*uV(3))*EQQ(5,9)...
    + (ST(2,3)*ST(3,2)*uV(1)-ST(2,1)*ST(3,2)*uV(3))*EQQ(2,2)...
    + (ST(1,3)*ST(3,2)*uV(2)-ST(1,2)*ST(3,2)*uV(3))*EQQ(2,4)...
    + (ST(2,1)*ST(3,3)*uV(2)-ST(2,2)*ST(3,3)*uV(1))*EQQ(3,3)...
    + (ST(1,1)*ST(2,2)*uV(1)-ST(1,1)*ST(2,1)*uV(2))*EQQ(3,7)...
    + (ST(1,1)*ST(1,2)*uV(2)-ST(1,2)^2*uV(1))*EQQ(6,8);
EQ3a(3,1) = (ST(2,1)*ST(3,1)*uV(3)-ST(2,1)*ST(3,3)*uV(1))*EQQ(1,5)...
    + (ST(2,1)^2*uV(2)-ST(2,1)*ST(2,2)*uV(1))*EQQ(1,9)...
    + (ST(1,2)*ST(3,3)*uV(1)-ST(1,2)*ST(3,1)*uV(3))*EQQ(5,5)...
    + (ST(1,2)*ST(2,2)*uV(1)-ST(1,2)*ST(2,1)*uV(2))*EQQ(5,9)...
    + (ST(1,1)*ST(3,2)*uV(3)-ST(1,1)*ST(3,3)*uV(2))*EQQ(2,2)...
    + (ST(2,2)*ST(3,3)*uV(2)-ST(2,2)*ST(3,2)*uV(3))*EQQ(2,4)...
    + (ST(2,2)*ST(2,3)*uV(3)-ST(2,3)^2*uV(2))*EQQ(3,7)...
    + (ST(1,3)*ST(3,1)*uV(2)-ST(1,3)*ST(3,2)*uV(1))*EQQ(6,6)...
    + (ST(1,3)*ST(2,1)*uV(3)-ST(1,3)*ST(2,3)*uV(1))*EQQ(6,8);
EQ3a(3,2) = (ST(2,1)*ST(3,2)*uV(3)-ST(2,1)*ST(3,3)*uV(2))*EQQ(1,1)...
    + (ST(1,2)*ST(3,3)*uV(2)-ST(1,2)*ST(3,2)*uV(3))*EQQ(1,5)...
    + (ST(1,2)*ST(2,1)*uV(1)-ST(1,1)*ST(2,1)*uV(2))*EQQ(1,9)...
    + (ST(1,1)*ST(1,2)*uV(2)-ST(1,2)^2*uV(1))*EQQ(5,9)...
    + (ST(2,2)*ST(3,3)*uV(1)-ST(2,2)*ST(3,1)*uV(3))*EQQ(2,2)...
    + (ST(1,1)*ST(3,1)*uV(3)-ST(1,1)*ST(3,3)*uV(1))*EQQ(2,4)...
    + (ST(2,3)*ST(3,1)*uV(2)-ST(2,3)*ST(3,2)*uV(1))*EQQ(3,3)...
    + (ST(1,3)*ST(2,3)*uV(2)-ST(1,2)*ST(2,3)*uV(3))*EQQ(3,7)...
    + (ST(1,3)^2*uV(1)-ST(1,1)*ST(1,3)*uV(3))*EQQ(6,8);
EQ3a(3,3) = (ST(2,1)*ST(2,3)*uV(2)-ST(2,1)*ST(2,2)*uV(3))*EQQ(1,1)...
    + (ST(1,3)*ST(2,1)*uV(1)-ST(1,1)*ST(2,1)*uV(3)+ST(1,2)*ST(2,2)*uV(3)-ST(1,2)*ST(2,3)*uV(2))*EQQ(1,5)...
    + (ST(1,1)*ST(1,2)*uV(3)-ST(1,2)*ST(1,3)*uV(1))*EQQ(5,5)...
    + (ST(1,1)*ST(1,3)*uV(2)-ST(1,1)*ST(1,2)*uV(3)+ST(2,1)*ST(2,2)*uV(3)-ST(2,2)*ST(2,3)*uV(1))*EQQ(2,2)...
    + (ST(1,1)*ST(2,3)*uV(1)-ST(1,1)*ST(2,1)*uV(3)+ST(1,2)*ST(2,2)*uV(3)-ST(1,3)*ST(2,2)*uV(2))*EQQ(2,4)...
    + (ST(2,2)*ST(2,3)*uV(1)-ST(2,1)*ST(2,3)*uV(2))*EQQ(3,3)...
    + (ST(1,2)*ST(1,3)*uV(1)-ST(1,1)*ST(1,3)*uV(2))*EQQ(6,6);
