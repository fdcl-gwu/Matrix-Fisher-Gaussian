...
Sigma = 1;
k = 10;
PReduced = [0.7,0]*Sigma/sqrt(k);

% tangent space
alpha1 = atan2(Miu2(2),Miu2(1));
alpha2 = acos(Miu2(3));
Rt = [-sin(alpha1), cos(alpha1), 0
      -cos(alpha1)*cos(alpha2), -sin(alpha1)*cos(alpha2), sin(alpha2)
      cos(alpha1)*sin(alpha2), sin(alpha1)*sin(alpha2), cos(alpha2)];
P = [PReduced,0]*Rt;
